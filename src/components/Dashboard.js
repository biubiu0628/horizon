  ...
  return (
    <div>
      <div className="grid grid-cols-[repeat(4,25%)] grid-rows-[70px_97px_repeat(4,345px)] py-8 gap-2">
        ...
        {/* h2c1 */}
        <div
          className="bg-white rounded-[20px] grid grid-cols-[20%_80%] 
          p-6 col-span-2"
        >
        ...
        >
          <div className="flex justify-between items-center">
            <p className="text-[24px] font-bold text-[#2B3674]">Check Table</p>
            <div className="size-[33px] bg-[#F4F7FE] flex justify-center items-center rounded-[10px] cursor-pointer">
        ...
        <div className="bg-white rounded-[20px] p-6">
          <p className="flex justify-between items-center">
            <span className="text-[14px] text-[#A3AED0]">Daily Traffic</span>
            <span className="flex text-[14px] font-bold text-[#05CD99]">
              <img src={Up} alt="" />
              +2.45%
            </span>
          ...
          <p>
            <span className="text-[34px] font-bold text-[#2B3674]">2.579 </span>

...
const Project = ({ image, name, id }) => (
  <div
    className="w-[450px] h-[108px] shadow-md flex pl-4 pr-8 
    rounded-2xl my-4 items-center justify-around"
  >
    ...
    <div className="grid grid-cols-[290px_1580px] bg-[#F4F7FE] gap-5">
      ...
      <div>
        ...
        <div className="flex flex-col">
          <div className="grid grid-cols-[552px_381px_617px] h-[365px] gap-4 my-4">
            {/* container1 */}
            <div className="bg-white rounded-[20px] p-5 flex flex-col items-center">
              <div className="relative">
                <img src={BgProfile} alt="" />
                <div className="absolute bottom-[-42px] left-[212.5px] size-[87px] rounded-full overflow-hidden border-4 border-solid border-white">
            ...
            {/* container3 */}
            <div className="bg-white rounded-[20px] p-5 flex items-center gap-8">
              <div
          ...
          <div className="grid grid-cols-[512px_617px_421px] h-[554px] gap-4">
            {/* container4 */}
            ...
            <div className="bg-white rounded-[20px] p-6">
              ...
              <div
                className="grid grid-cols-[repeat(2,268px)] grid-rows-[repeat(3,91px)] 
